 ...
 * @ClassName ：Orders
 * @description ：订单信息
 * @date ：2021/11/23 3:38
 */
public class Orders {

    private Integer id; //订单表主键
    private String orderNum; //订单编号 不为空且唯一
    private Date orderTime; //下单时间，Date格式需转换
    private String orderTimeStr; //下单时间字符串
    private int orderStatus; //订单状态数字表示（0未支付 1已支付）
    ...
    private Integer payType; //支付方式数字表示（0支付宝 1微信 2其它）
